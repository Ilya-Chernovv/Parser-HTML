...
import ParserHTML.actions.*;
import ParserHTML.listeners.TextEditMenuListener;
import ParserHTML.listeners.UndoMenuListener;
...
public class MenuHelper {
    public static JMenuItem addMenuItem(JMenu parent, String text, ActionListener actionListener) {
        JMenuItem menuItem = new JMenuItem(text); //Создаем новый пункт меню JMenuItem, используя text.
        menuItem.addActionListener(actionListener); //Устанавливаем этому пункту слушателя действий с помощью метода addActionListener().
        parent.add(menuItem); //Добавляем в parent созданный пункт меню.
        return menuItem; //Возвращаем новый пункт меню.
    }
